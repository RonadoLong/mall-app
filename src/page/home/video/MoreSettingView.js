                ...
                <View style={styles.contentView}>
                    <View style={styles.optionView}>
                        <TouchableOpacity style={styles.itemView} onPress={this._onTapFavorite}>
                            <Image
                                source={require('../../../res/images/video/icon_video_favorite.png')}
                        ...
                        <TouchableOpacity style={[styles.itemView, {marginLeft: 40}]} onPress={this._onTapDownload}>
                            <Image
                                source={require('../../../res/images/video/icon_video_download.png')}
                                style={styles.imageItem}
                            />
                        ...
                        <TouchableOpacity style={[styles.itemView, {marginLeft: 40}]} onPress={this._onTapMute}>
                            <Image
                                source={this.state.isMute ? require('../../../res/images/video/icon_video_muted.png') : require('../../../res/images/video/icon_video_mute.png')}
                                style={styles.imageItem}
                            />
                    ...
                    <View style={styles.optionView}>
                        ...
                        <Image
                            source={require('../../../res/images/video/icon_volume_off.png')}
                        ...
                        />
                        <Image
                            source={require('../../../res/images/video/icon_volume_up.png')}
