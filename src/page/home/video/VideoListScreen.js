...
export default class VideoListScreen extends React.Component {
        ...
        return (
            <TouchableHighlight underlayColor={'#dcdcdc'} onPress={() => {this.itemSelected(url)}}>
                <View style={styles.itemContainer}>
                    ...
                    <Image source={require('../../../res/images/video/icon_right.png')} style={styles.rightIcon}/>
                </View>
            </TouchableHighlight>
        )
    };
    ...
    itemSelected(url) {
        this.props.navigation.navigate('VideoPlayScreen', {url: url});

        // if (this.state.routeName === 'Mode1') {
        //     this.props.navigation.navigate('VideoPlayScreen', {url: url});
        // } else {
