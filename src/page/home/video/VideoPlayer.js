...
import {defaultVideoHeight, isIPhoneX, screenWidth, statusBarHeight} from "../../../widget/color";
...
export default class VideoPlayer extends React.Component {
    ...
    static defaultProps = {
        ...
        // videoCover: '',  // 视频的封面图地址
        // videoTitle: '',  // 视频的标题
        // enableSwitchScreen: false, // 是否允许视频切换大小
        // tag: 0
    };
    ...
    constructor(props) {
        super(props);
        let hasCover = true;
        console.log(this.props.videoCover)
        ...
        this.state = {
            ...
            videoUrl: this.props.isPaused ?  null : this.props.videoUrl,
            videoCover: this.props.videoCover,
            videoTitle: this.props.videoTitle,
            hasCover: hasCover, // 是否有视频封面
            isPaused: this.props.isPaused,  // 是否暂停，控制视频的播放和暂停
            duration: 0,     // 视频的时长
            ...
            isSettingViewShow: this.props.isSettingViewShow, // 是否显示设置界面
            isBackBtnShow: this.props.isBackBtnShow,
            enableSwitchScreen: this.props.enableSwitchScreen,
            showBottomOptionView: false, //显示高清选择
        }
    }

    render() {

        let video = this.state.videoUrl != null ?
            <Video
        ...
        return (
            <View
                            ...
                            this.state.isPaused ?
                                <TouchableWithoutFeedback onPress={this._onTapPlayButton}>
                                    <Image
                                        ...
                                        source={require('../../../res/images/video/icon_video_play.png')}
                                    />
                ...
                </TouchableWithoutFeedback>
                {
                    this.state.isShowControl ?
                        <View style={[styles.bottomControl, {width: this.state.videoWidth}]}>
                            <Image
                                source={require('../../../res/images/video/img_bottom_shadow.png')}
                            ...
                            <TouchableOpacity activeOpacity={0.3} onPress={this._onTapPlayButton}>
                                <Image
                                    ...
                                    source={this.state.isPaused ? require('../../../res/images/video/icon_control_play.png') : require('../../../res/images/video/icon_control_pause.png')}
                                />
                            </TouchableOpacity>
                            ...
                            <Slider
                                ...
                                thumbImage={require('../../../res/images/video/icon_control_slider.png')}
                                ...
                                this.props.enableSwitchScreen ?
                                    <TouchableOpacity activeOpacity={0.3} onPress={this._onTapSwitchButton}>
                                        <Image
                                            ...
                                            source={this.state.isFullScreen ? require('../../../res/images/video/icon_control_shrink_screen.png') : require('../../../res/images/video/icon_control_full_screen.png')}
                                        />
                                    </TouchableOpacity> : null
                            }
                            {
                                this.state.isFullScreen && this.state.showBottomOptionView?
                ...
                }
                {
                    this.state.isFullScreen && this.state.isShowControl ?
                        <View
                            ...
                            <Image
                                source={require('../../../res/images/video/img_top_shadow.png')}
                                style={{position:'absolute', top: 0, left: 0, width: this.state.videoWidth, height:50}}
                            />
                                ...
                                this.state.isFullScreen ?
                                    <View style={styles.topOptionView}>
                                        <TouchableOpacity style={styles.topOptionItem} onPress={this._onTapMoreButton}>
                                            <Image
                                                source={require('../../../res/images/video/icon_video_more.png')}
                ...
                {
                    this.state.isFullScreen || !this.state.isBackBtnShow ? null :
                        <TouchableOpacity
                            style={{
                                position:'absolute',
                                top: 10,
     ...
     *    <TouchableOpacity style={styles.topOptionItem} onPress={this._onTapCaptureImage}>
     <Image
     source={require('../../res/images/video/icon_video_capture.png')}
     style={{width: 26, height: 26}}
     />
     </TouchableOpacity>
     <TouchableOpacity style={styles.topOptionItem} onPress={this._onTapAirplayButton}>
     <Image
     source={require('../../res/images/video/icon_video_airplay.png')}
     style={styles.topImageOption}
     />
     </TouchableOpacity>
     <TouchableOpacity style={styles.topOptionItem} onPress={this._onTapShareButton}>
     <Image
     source={require('../../res/images/video/icon_video_share.png')}
    ...
    componentDidMount(){
        this.subscription = DeviceEventEmitter.addListener('videoStopEvent', this._eventCall.bind(this));
    };
    ...
    _onTapPlayButton = () => {
        ...
        if (!isPause) {
            isShowControl = true;
            console.log("播放事件 ======= ")
            DeviceEventEmitter.emit('videoStopEvent', "1")
