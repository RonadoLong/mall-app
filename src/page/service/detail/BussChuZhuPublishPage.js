...
export default class BussChuZhuPublishPage extends Component<Props> {
    ...
    render() {
        ...
        let ScrollViewbanner =
            this.state.photos.length > 0 ?
                ...
                :
                <TouchableOpacity style={styles.image} activeOpacity={0.75}
                                  onPress={this.handleAsyncSelectPhoto.bind(this)}>
        ...
        let ScrollViewtop =
            <View style={styles.centerView}>
                ...
                <Sae style={styles.containerStyle} label={'标题(不少于8个字)'} labelStyle={styles.labelStyle}
        ...
        let ScrollViewCenterfangzi =
            <View style={styles.centerView}>
                ...
                <Picker data={ServiceDetailAddress.shangpuType} cols={1}
                        value={this.state.roomType} onChange={v => this.setState({roomType: v})}
                        onOk={v => this.setState({roomType: v})}>
                    <List.Item arrow="horizontal">
                        <Text style={{fontSize: 17, color: '#91627b', fontWeight: '500'}}>商铺类型</Text>
                    </List.Item>
                </Picker>
                ...
                <Sae
                    style={styles.containerStyle} onChangeText={(text) => {
        ...
        let ScrollViewcenter =
            <View style={styles.centerView}>
                ...
                <Sae style={styles.containerStyle} onChangeText={(text) => {
