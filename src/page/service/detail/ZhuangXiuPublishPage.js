...
type Props = {}
export default class ZhuangXiuPublishPage extends Component<Props> {
    ...
    render() {
        ...
        let ScrollViewTop =
            <View style={styles.centerView}>
                ...
                <Sae style={styles.containerStyle} label={'服务内容'} labelStyle={styles.labelStyle}
                    iconClass={FontAwesomeIcon} iconName={'pencil'} iconColor={color.primary}
                    inputStyle={{ color: '#91627b' }}
                     onChangeText={(text) => { this.setState({zhiwei: text}) }}
                />
                <Sae
                    style={styles.containerStyle} label={'服务优势'}
